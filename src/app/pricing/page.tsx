...
export const metadata: Metadata = {
  title: "Pricing",
  description: "Compare AgentProof verification capacity for AI agents, from free access to Builder and Agency plans.",
